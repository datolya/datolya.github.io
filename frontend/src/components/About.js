...
function About() {
  const team = [
    ...
    {
      name: "Bálint Cocchioni",
      role: "Co-Founder & Data Scientist",
      linkedin: "https://www.linkedin.com/in/balint-cocchioni/",
      github: "https://github.com/datolya",
      upwork: "https://www.upwork.com/freelancers/~01a5243280df09e2b4"
    }
  ];
        ...
        <div className="container about-content-container">
          ...
          <div className="about-grid">
            ...
            <div className="company-intro">
              <h3>You Are What You <i>Data</i></h3>
              <p className="lead">
                A boutique data engineering consultancy specialized in cloud engineering, large scale data processing, analytics engines, graphing and BI, feature iteration and monetization.
              </p>
              <p>
                <b>We turn data chaos into revenue!</b>
                <br />
