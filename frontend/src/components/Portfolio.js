  ...
  const projects = [
    {
      ...
      description: (
        <>
          Unified accounting & reporting
          <br /> Plug-and-play with major providers
          <br />
    ...
    },
    {
      ...
      description: (
        <>
          State of the art business graphing
          <br /> Complex output data into actionables
          <br />
    ...
    <>
      ...
      <section id="portfolio" className="portfolio" style={{
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2, maxWidth: '960px' }}>
          <h2 className="text-center mb-5">Enterprise Ready</h2>
