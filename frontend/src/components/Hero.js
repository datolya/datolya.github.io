      ...
      <header id="home">
        ...
        <div className="container hero-content">
          <div className="hero-text-container">
            <h1 style={{textAlign: 'left'}}>Data-as-a-Service</h1>
            ...
            <div className="hero-intro">
              <p className="intro-paragraph" style={{paddingLeft: '0px'}}>
                <strong>Data x Computing carve out the edge in competition</strong> Only the latest engineering toolkit predicts what's next
              </p>

              <p className="intro-paragraph" style={{paddingLeft: '20px'}}>
                <strong>We believe information is the one true Business backbone</strong> Our motto is strong intelligence foundation and simple, plug-and-play analytics
              </p>

              <p className="intro-paragraph" style={{paddingLeft: '40px'}}>
                <strong> Our team carried €100M+ tech acquisitions to success</strong> We offer industry leading know-how to audit information systems
              </p>
            </div>

            <p className="hero-origin">
              <em>datolya</em> — Hungarian for date fruit. Dates are hard to find in a vast ocean of sand. Yet in numbers, they're a concentrated energy boost to fuel survival in the harsh climate.
            </p>
